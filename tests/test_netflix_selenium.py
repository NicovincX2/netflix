...
def test_download_seen(netflix_headless, tmp_path):
    netflix_headless.download_dir = tmp_path

    netflix_headless.download_seen()
    assert os.path.exists(
        netflix_headless.download_dir + "/" + netflix_headless.download_file_name
    )


def test_get_json(netflix_headless, tmp_path):
    netflix_headless.download_dir = tmp_path
    ...
    assert os.path.exists(netflix_headless.download_dir + "/rated_titles.json")
    ...
    assert os.path.exists(netflix_headless.download_dir + "/seen_titles.json")
